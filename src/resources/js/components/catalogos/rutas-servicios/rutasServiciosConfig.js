// src/resources/js/components/catalogos/rutas-servicios/rutasServiciosConfig.js
...
export const configTipoPersona = {
    ...
    fields: {
        ...
        tipo_persona_tipo: { label: 'Tipo', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
...
export const configEstado = {
    ...
    sortableFields: ['estado_codigo', 'estado_estado'],
    filterableFields: []
};
...
export const configAgencia = {
    ...
    fields: {
        ...
        agencia_razon_social: { label: 'Razón Social', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        agencia_nit: { label: 'NIT', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
    ...
    sortableFields: ['agencia_codigo', 'agencia_razon_social', 'agencia_nit'],
    filterableFields: []
};
...
export const configPersona = {
    ...
    fields: {
        ...
        tipo_persona_id: { label: 'Tipo', type: 'number', sortable: true, filterable: true, sortType: 'numeric' },
        persona_situacion: {
            label: 'Estado',
            type: 'select',
            sortable: true,
    ...
    searchableFields: ['persona_codigo', 'persona_nombres', 'persona_apellidos', 'persona_email'],
    sortableFields: ['persona_nombres', 'persona_apellidos', 'persona_codigo'],
    filterableFields: []
};
...
export const configVehiculo = {
    ...
    sortableFields: ['vehiculo_placa', 'vehiculo_marca', 'vehiculo_modelo', 'vehiculo_capacidad'],
    filterableFields: []
};
...
// CONFIGURACIÓN ESPECÍFICA PARA RUTAS-SERVICIOS (TU MÓDULO ACTUAL)
export const rutasServiciosConfig = {
    rutas: configRutas,
