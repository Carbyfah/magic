// src/resources/js/components/comercial/agencias/agenciasConfig.js
...
export const configAgencias = {
    ...baseConfig,
    tableName: 'agencia',
    displayName: 'Agencias',
    primaryKey: 'agencia_id',
    defaultSortField: 'agencia_razon_social',
    ...
    searchableFields: ['agencia_codigo', 'agencia_razon_social', 'agencia_nit', 'agencia_email'],
    sortableFields: ['agencia_codigo', 'agencia_razon_social', 'agencia_nit', 'agencia_telefono'],
...
export const configEstados = {
    ...
    fields: {
        estado_id: { label: 'ID', type: 'number', sortable: true, filterable: false, sortType: 'numeric' },
        estado_codigo: { label: 'Código', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        estado_estado: { label: 'Estado', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        estado_descripcion: { label: 'Descripción', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        estado_situacion: {
            label: 'Estado',
            type: 'select',
            sortable: true,
...
export const configServicios = {
    ...
    fields: {
        servicio_id: { label: 'ID', type: 'number', sortable: true, filterable: false, sortType: 'numeric' },
        servicio_codigo: { label: 'Código', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        servicio_servicio: { label: 'Servicio', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        servicio_origen: { label: 'Origen', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        servicio_destino: { label: 'Destino', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        servicio_precio_normal: { label: 'Precio Normal', type: 'number', sortable: true, filterable: false, sortType: 'numeric' },
        servicio_precio_descuento: { label: 'Precio Descuento', type: 'number', sortable: true, filterable: false, sortType: 'numeric' },
        servicio_descripcion: { label: 'Descripción', type: 'text', sortable: false, filterable: true, sortType: 'alphabetic' },
        servicio_politicas: { label: 'Políticas', type: 'text', sortable: false, filterable: true, sortType: 'alphabetic' },
        servicio_situacion: {
            label: 'Estado',
            type: 'select',
            sortable: true,
...
export const configRutas = {
    ...
    fields: {
        ruta_id: { label: 'ID', type: 'number', sortable: true, filterable: false, sortType: 'numeric' },
        ruta_codigo: { label: 'Código', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        ruta_ruta: { label: 'Nombre de Ruta', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        ruta_origen: { label: 'Origen', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        ruta_destino: { label: 'Destino', type: 'text', sortable: true, filterable: true, sortType: 'alphabetic' },
        ruta_situacion: {
            label: 'Estado',
            type: 'select',
            sortable: true,
...
// CONFIGURACIÓN ESPECÍFICA PARA AGENCIAS (TU MÓDULO ACTUAL)
export const agenciasConfig = {
    agencias: configAgencias
};
