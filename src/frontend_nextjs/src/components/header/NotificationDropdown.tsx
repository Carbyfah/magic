...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute -right-[240px] mt-4 flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-lg dark:border-gray-800 dark:bg-gray-900 sm:w-[361px] lg:right-0 z-50">
          ...
          <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
            {/* Ejemplo de elementos de notificación */}
            <li>
              <div
              ...
              >
                ...
                <span className="block">
                  <span className="mb-1.5 block text-sm text-gray-500 dark:text-gray-400 space-x-1">
                    ...
                    <span>solicita permisos para cambiar</span>
                    <span className="font-medium text-gray-800 dark:text-white/90">
                      Proyecto - Magic Travel
                    </span>
                  </span>
