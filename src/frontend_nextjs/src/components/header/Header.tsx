...
interface HeaderProps {
  onClick?: () => void; // Función opcional que no toma argumentos y no retorna nada
  onToggle: () => void;
}
          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <input
                ...
                className="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/10 dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-600 xl:w-[430px]"
              />
